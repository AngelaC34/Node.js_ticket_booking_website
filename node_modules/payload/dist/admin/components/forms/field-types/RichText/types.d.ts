...
type RichTextAdapterBase<Value extends object = object, AdapterProps = any, ExtraFieldProperties = {}> = {
    ...
    outputSchema?: ({ collectionIDFieldTypes, field, interfaceNameDefinitions, isRequired, payload, }: {
...
export type RichTextAdapter<Value extends object = object, AdapterProps = any, ExtraFieldProperties = {}> = RichTextAdapterBase<Value, AdapterProps, ExtraFieldProperties> & ({
    ...
    LazyCellComponent: () => Promise<React.FC<CellComponentProps<RichTextField<Value, AdapterProps, ExtraFieldProperties>>>>;
    LazyFieldComponent: () => Promise<React.FC<RichTextFieldProps<Value, AdapterProps, ExtraFieldProperties>>>;
});
export {};
